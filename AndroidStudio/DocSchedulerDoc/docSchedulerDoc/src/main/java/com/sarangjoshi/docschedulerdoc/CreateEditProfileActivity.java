...
public class CreateEditProfileActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_createedit_profile);
            ...
            if (!hasErrors()) {
                ...
                user.saveInBackground(new SaveCallback() {
                    ...
                    public void done(ParseException e) {
                        ...
                        if (e == null) {
                            // User saved
                            Toast.makeText(CreateEditProfileActivity.this,
                                    "Profile saved!", Toast.LENGTH_SHORT).show();
                            // Intent intent = new
                            // Intent(CreateEditProfileActivity.this,HomeActivity.class);
                            // startActivity(intent);
                            finish();
                        } else {
                            Toast.makeText(CreateEditProfileActivity.this, e.getMessage(),
